...
- [charmbracelet/soft-serve](https://github.com/charmbracelet/soft-serve) ([v0.4.3](https://github.com/charmbracelet/soft-serve/releases/tag/v0.4.3), today) - A tasty, self-hostable Git server for the command line🍦
